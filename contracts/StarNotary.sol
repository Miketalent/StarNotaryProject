...
contract StarNotary is ERC721 {
    ...
    function lookUptokenIdToStarInfo (uint _tokenId) public view returns (string memory) {
        ...
        bytes memory starInfo = bytes(tokenIdToStarInfo[_tokenId].name);
        require(starInfo.length > 0, "The Star should already be owned"); //ensure star already has an owner
        return string(starInfo);
    }
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        require(owner1Address == msg.sender || owner2Address == msg.sender, "You can only exchange with star you own");
        //exchange stars
    ...
    function transferStar(address _to1, uint256 _tokenId) public {
        ...
        require(ownerOf(_tokenId) == msg.sender, "you can only transfer star you owned!");
